...
const valueH = (app) =>{
   ...
   // app.use(CheckToken());
    app.post("/api/values/create",CheckToken(),upload.single("image"),valueH_controller.create);
    app.put("/api/values/update",CheckToken(),upload.single("image"),valueH_controller.update);
