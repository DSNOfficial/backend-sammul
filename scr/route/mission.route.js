...
const mission = (app) =>{
    ...
    app.post("/api/mission/create",CheckToken(),upload.single("image"),mission_controller.create);
    app.put("/api/mission/update",CheckToken(),upload.single("image"),mission_controller.update);
