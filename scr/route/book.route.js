...
const book = (app) => {
    ...
    app.post("/api/book/create", upload_file.single('file'), book_controller.create);
    app.put("/api/book/update/", upload_file.single('File'), book_controller.update);
    app.delete("/api/book/delete", book_controller.remove);
